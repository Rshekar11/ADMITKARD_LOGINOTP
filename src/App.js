      ...
      <div className="">
        ...
        {user ? (
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="text-[#999] w-60 mt-5 text-justify lg:text-2xl">
            ...
            <div className="my-20">
              <button
                ...
                className="bg-[#F7B348] px-8 py-2 rounded-3xl my-2"
              >
                Get Started
              </button>
          ...
          <div className="w-80 flex flex-col items-center justify-center gap-4 rounded-lg p-4">
            {!showOTP && (
              <>
                ...
                <div className="mt-[111px] text-center">
                  ...
                  <p className="my-5 text-[#666] text-xs ">
            ...
            {showOTP ? (
              <>
               ...
               {warn &&(<p className="text-red-500">wrong otp enterd*</p>)} 
                <p>
